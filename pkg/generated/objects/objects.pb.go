...
var file_objects_proto_rawDesc = []byte{
	...
	0x22, 0x00, 0x32, 0xd5, 0x02, 0x0a, 0x0a, 0x43, 0x65, 0x6c, 0x6c, 0x4d, 0x61, 0x73, 0x74, 0x65,
	...
	0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x4b, 0x0a,
	0x16, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x4d, 0x75, 0x74, 0x61, 0x74, 0x69, 0x6e, 0x67,
	0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x12, 0x15, 0x2e, 0x6f, 0x62, 0x6a, 0x65, 0x63, 0x74,
	...
	0x6f, 0x61, 0x64, 0x63, 0x61, 0x73, 0x74, 0x4d, 0x75, 0x74, 0x61, 0x74, 0x65, 0x64, 0x4f, 0x42,
	...
	0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x39, 0x0a, 0x0c, 0x47, 0x65, 0x74, 0x43, 0x65, 0x6c,
	0x6c, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x0d, 0x2e, 0x6f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x73,
	...
	0x00, 0x12, 0x37, 0x0a, 0x07, 0x49, 0x73, 0x41, 0x6c, 0x69, 0x76, 0x65, 0x12, 0x15, 0x2e, 0x6f,
	0x62, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x13, 0x2e, 0x6f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x2e, 0x45, 0x6d,
	0x70, 0x74, 0x79, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_objects_proto_depIdxs = []int32{
	...
	5, // 4: objects.CellMaster.RequestMutatingObjects:input_type -> objects.EmptyRequest
...
type CellMasterClient interface {
	...
	RequestMutatingObjects(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*MultipleObjects, error)
...
func (c *cellMasterClient) RequestMutatingObjects(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*MultipleObjects, error) {
...
type CellMasterServer interface {
	...
	RequestMutatingObjects(context.Context, *EmptyRequest) (*MultipleObjects, error)
...
func (*UnimplementedCellMasterServer) RequestMutatingObjects(context.Context, *EmptyRequest) (*MultipleObjects, error) {
...
func _CellMaster_RequestMutatingObjects_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CellMasterServer).RequestMutatingObjects(ctx, req.(*EmptyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
